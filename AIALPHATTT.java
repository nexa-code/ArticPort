...
public class AIALPHATTT {
    ...
    private static int[] minimax(char[][] board, char player, int alpha, int beta) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if (board[i][j] == ' ') {
                    board[i][j] = player;
                    int score = minimaxScore(board, player, false, alpha, beta);
    ...
    private static int minimaxScore(char[][] board, char player, boolean isMaximizing, int alpha, int beta) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if (board[i][j] == ' ') {
                    ...
                    int score = minimaxScore(board, player, !isMaximizing, alpha, beta);
                    board[i][j] = ' '; // undo the move
